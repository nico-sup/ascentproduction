<template>
    <div v-editable="blok" class="hero_banner hero_banner_img relative flex justify-center items-start flex-col">
        ...
        <div class="z-[2] pl-5 md:pl-20 mb-9">
            <h1 class="relative text-white font-cormorant font-bold uppercase mb-16 text-[2rem]"> {{ blok.title }} <span class="opacity-0 absolute left-0">Vidéaste professionnel à clermont-ferrand clermont</span> </h1>
